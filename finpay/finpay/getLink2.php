...
<form method="POST" action="getLink2.php">
<fieldset>
...
<table>
  ...
  <tr><td width="160">Return URL</td><td><input type="text" name="trx_returnurl" size="100" maxlength="100"  value="http://103.15.226.133/telkomsel/success_1/test/"></td></tr>
...
<table>
  <tr><td width="160">Customer ID</td><td><input type="text" name="cust_id" size="16" maxlength="16"  value="081286288846"></td></tr>
