...
<body class="landing-page">
    ...
    <div class="wrapper"  style="background-color: #f0f1f3">
    	<!-- konten halaman		 -->
    	<div class="header"  style="background-image: url('<?php echo base_url()?>assets/img/desk.png'); background-size: cover;height: 60vh; min-height: auto">
            <div class="container" style="padding-top: 20vh; width: 80%">
                <div class="row">
					<div class="col-md-6" style="color: black">
						<p id="judul_kepedulian_kami" style="font-weight: inherit;color: #4fc143"><?php echo $this->lang->line('program_terkini')?></p>
	                    <p id="deskripsi_kepedulian_kami">Kami menggalang dana dari para dermawan untuk disalurkan kepada sesama dan kegiatan sosial yang membutuhkan.</p>
					</div>
                </div>
            </div>
        </div>
			...
			<div class="container">
		    	<div class="section text-center section-landing">
	                <div class="row">
	                    ...
	                    <div class="col-md-6" >
	                    	<div class="card" align="left" style="padding: 30px; height: 450px; margin-top: 15px">
	                    		<img class="img" style="width: 30%" src="<?php echo base_url()?>assets/img/sosialkemanusiaan.png">
		                        <h4 class="title">Sosial dan kemanusiaan</h4>
		                        ...
		                        <div class="row">
		                        	<div class="col-md-6">
		                        		<h5><i class="material-icons">sort</i> Anak yatim</h5>
		                        		<h5><i class="material-icons">sort</i> Anak terlantar/tidak mampu</h5>
		                        	</div>
		                        	<div class="col-md-6">
		                        		<h5><i class="material-icons">sort</i> Janda/orang tua terlantar</h5>
		                        		<h5><i class="material-icons">sort</i> Modal kerja bagi simiskin</h5>
		                        	</div>
		                        </div>
		                    </div>
	                    </div>
	                    ...
	                    <div class="col-md-6" >
	                    	<div class="card"  align="left" style="padding: 30px; height: 450px; margin-top: 15px">
	                    		<img class="img" style="width: 30%" src="<?php echo base_url()?>assets/img/bencana_alam.png">
		                        <h4 class="title">Bencana alam</h4>

		                        <h5 class="description">This is the paragraph where you can write more details about your product. Keep you user engaged by providing meaningful information.</h5>
		                        <div class="row">
		                        	<div class="col-md-6">
		                        		<h5><i class="material-icons">sort</i> Longsor dan banjir</h5>
		                        		<h5><i class="material-icons">sort</i> Gunung meletus</h5>
		                        	</div>
		                        	<div class="col-md-6">
		                        		<h5><i class="material-icons">sort</i> Pengungsi</h5>
		                        		<h5><i class="material-icons">sort</i> lain-lain (sarana dan prasarana)</h5>
		                        	</div>
		                        </div>
		                    </div>
	                    </div>
	                    ...
	                    <div class="col-md-6" >
	                    	<div class="card" align="left" style="padding: 30px; height: 450px; margin-top: 15px">
	                    		<img class="img" style="width: 30%" src="<?php echo base_url()?>assets/img/pendidikan.png">
		                        <h4 class="title">Pendidikan</h4>
		                        <h5 class="description">This is the paragraph where you can write more details about your product. Keep you user engaged by providing meaningful information. </h5>
		                        <div class="row">
		                        	<div class="col-md-6">
		                        		<h5><i class="material-icons">sort</i> Sekolah rusak</h5>
		                        		<h5><i class="material-icons">sort</i> Rumah ibadah</h5>
		                        	</div>
		                        	<div class="col-md-6">
		                        		<h5><i class="material-icons">sort</i> Beasiswa bagi anak didik</h5>
		                        		<h5><i class="material-icons">sort</i> Bangun sarana dan prasarana</h5>
		                        	</div>
		                        </div>
		                    </div>
	                    </div>
	                    ...
	                    <div class="col-md-6" >
	                    	<div class="card" align="left" style="padding: 30px; height: 380px; margin-top: 15px">
	                    		<img class="img" style="width: 30%" src="<?php echo base_url()?>assets/img/sumbangan_bebas.png">
		                        <h4 class="title">Sumbangan bebas</h4>
		                        <h5 class="description">This is the paragraph where you can write more details about your product. Keep you user engaged by providing meaningful information.</h5>
		                        <div class="row">
		                        	<div class="col-md-12">
		                        		<h5><i class="material-icons">sort</i> Akan digunakan untuk bantuan atas dasar rekomendasi pada kejadian saat itu </h5>
		                        	</div>
		                        </div>
		                    </div>
	                    </div>
	...
	$(document).ready(function() {
        ...
        if (window_width <= 768) {
           $("#head1").hide();
			$("#navbar_desktop").hide();
			$("#navbar_mobile").show();
           $("#judul_kepedulian_kami").css('font-size','1.5em');
           $("#judul_kepedulian_kami").css('font-weight','bold');
		}
        else{
            $("#judul_kepedulian_kami").css('font-size','2.6em');
            $("#head1").show();
			$("#navbar_desktop").show();
			$("#navbar_mobile").hide();
        }
