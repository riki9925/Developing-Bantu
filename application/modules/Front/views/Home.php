...
<body class="landing-page">
		    	...
		    	<ul class="nav navbar-nav navbar-right">
					...
					<li style="color: rgb(43, 110, 36); font-size: 13px" class="menu-item  dropdown"><a title="Categories" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="false"><?php echo $this->lang->line('aktivitas_kami')?> <span class="caret"></span></a>
						<ul role="menu" class=" dropdown-menu">
							<li  class="menu-item">
								<a href="<?php echo base_url();?>Front/Kepedulian_kami" ><?php echo $this->lang->line('program_terkini')?></a>
							</li>
							<li  class="menu-item">
								<a  href="<?php echo base_url();?>Front/Jaringan_global"><?php echo $this->lang->line('jaringan_global')?></a>
							</li>
						</ul>
					</li>
					...
					<li style="color: rgb(43, 110, 36); font-size: 13px" class="menu-item  dropdown"><a title="Categories" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="false"><?php echo $this->lang->line('berita_dan_media')?><span class="caret"></span></a>
						<ul role="menu" class=" dropdown-menu">
							...
							<li class="menu-item">
								<a href="<?php echo base_url();?>Front/Berita_foto">Foto</a>

							<!-- <li  class="menu-item"><a onclick="get_content('Berita_video')" href="#front">Video</a></li> -->
							<li class="menu-item">
								<a href="<?php echo base_url();?>Front/Berita_video">Video</a>
						</ul>
					</li>
					...
					<li style="color: rgb(43, 110, 36); font-size: 13px" class="menu-item  dropdown"><a title="Categories" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="false"><?php echo $this->lang->line('panduan_berdonasi')?> <span class="caret"></span></a>
						<ul role="menu" class=" dropdown-menu">
							...
							<li class="menu-item">
								<a href="<?php echo base_url();?>Front/Donasi_online2">Donasi Online</a>


							<li  class="menu-item">
								<a href="<?php echo base_url();?>Front/Donasi_trf2">Donasi Transfer online</a>
						</ul>
					</li>
					...
					<li style="color: rgb(43, 110, 36); font-size: 13px" class="menu-item  dropdown"><a title="Categories" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="false"><?php echo $this->lang->line('tentang_kami')?> <span class="caret"></span></a>
						<ul role="menu" class=" dropdown-menu">
										...
										<li  class="menu-item">
												<a href="<?php echo base_url();?>Front/Sejarah2">Tentang Kami Semua</a>
										...
										<li  class="menu-item">
												<a href="<?php echo base_url();?>Front/Halaman_kami">Visi Misi</a>
										<!-- <li>
										...
										<li  class="menu-item">
												<a href="<?php echo base_url();?>Front/Management2">Manajemen</a>
										...
										<li  class="menu-item">
												<a href="<?php echo base_url();?>Front/Mitra2">Partner</a>
										<!-- <li>
										...
										<li  class="menu-item">
												<a href="<?php echo base_url();?>Front/Karir2">Karir</a>
										<!-- <li>
										...
										<li  class="menu-item">
												<a href="<?php echo base_url();?>Front/Kontak2">Kontak Kami</a>
						</ul>
					</li>
					...
					<button onclick="get_content()" class="btn btn-info"><?php echo $this->lang->line('donasi_sekarang')?><div class="ripple-container"></div></button>
	...
	<div class="se-pre-con" id="ajxLoader" hidden=""></div>

    <div class="wrapper" id="content_page" style="background-color: #f0f1f3">
    	<!-- konten halaman		 -->
	</div>
				...
				<div class="modal fade" id="search" role="dialog">
                    <div class="modal-dialog" style="width: 96%">
                        <div class="modal-content" style="background-color: #fff; height: 619px">
                           
                            <div class="modal-body">
                            	<div class="row">
                            		<div class="col-sm-12">
                            			<button type="button" class="close" data-dismiss="modal"><i style="color: #14193c;font-size: 50px; margin-bottom: 0px" class="material-icons">close</i></button>
                            		</div>
                            		<div class="col-sm-6" style="margin-top: -50px; margin-left: 10px">
                            			<div class="form_cari">
                            			<div id="class_cari" class="form-group form-header label-floating">
                                            <input id="cari_header" class="form-control" style="font-size: 35px;height: 70px;color: #14193c" type="text">
                                            <p style="color: #191f47">Tekan ENTER untuk memulai pencarian</p>
                                        <span class="material-input"></span></div>
                                        </div>

                                        <style type="text/css">
                                        	
                                        	.form-cari .form-group.is-focused .form-control{
                                        		background-image: linear-gradient(#14193c, #14193c), linear-gradient(#14193c, #14193c)
                                        	}
                                        </style>
                            		</div>
                            	</div>

                            	<div id="hasil_cari" class="row" style="margin-top: 10px;overflow-y: auto;max-height: 430px;">
                ...
                <!-- modals detil berita desktop-->
				<div class="modal fade" id="detil_berita" role="dialog">
                            	...
                            	<div class="row">
                            		<div class="col-xs-6">
                            			<div class="stats" style="font-size: 15px">
											<i class="material-icons">date_range</i> <span id="date_berita">Last 24 Hours</span>
										</div>
                            		</div>
                            		<div class="col-xs-6" align="right">
                            			<button type="button" class="close" data-dismiss="modal"><i style="color: #14193c;font-size: 30px; margin-bottom: 0px" class="material-icons">close</i></button>
                            		</div>
                            		<div class="col-xs-12" style="text-align:left">
                            		<hr>
                            			<h4 id="judul_berita" style="font-weight: bold">news 4</h4>
                            			<h4 id="deskripsi_berita">news 4</h4>
                            		</div>
                            		<div class="col-sm-12">
                            			<img class="img" id="img_berita" src="http://salingbantu.or.id/assets/img/berita/201706180458011.jpg" style="width: 100%">
                            		</div>
                            	</div>
                            </div>
                        </div>
                ...
                <!-- modals detil berita mobile-->
				<div class="modal fade" id="detil_berita_mobile" role="dialog">
                    <div id="width_modal_berita" class="modal-dialog" style="width: 90%">
                        <div class="modal-content" style="background-color: #fff;">
                            <div class="modal-body">
                            	<div class="row">
                            		<div class="col-xs-6">
                            			<div class="stats" style="font-size: 15px">
											<i class="material-icons">date_range</i> <span id="date_berita_mobile">Last 24 Hours</span>
										</div>
                            		</div>
                            		<div class="col-xs-6" align="right">
                            			<button type="button" class="close" data-dismiss="modal"><i style="color: #14193c;font-size: 30px; margin-bottom: 0px" class="material-icons">close</i></button>
                            		...
                            		<div class="col-xs-12" style="text-align:left">
                            		<hr>
                            			<h4 id="judul_berita_mobile" style="font-weight: bold"></h4>
                            			<h4 id="deskripsi_berita_mobile">news 4</h4>
                            		</div>
                            		<div class="col-xs-12">
                            			<img class="img" id="img_berita_mobile" src="" style="width: 100%">
                            		</div>
                            	</div>
                            </div>
                        </div>
                ...
                <!-- modals preview foto -->
				<div class="modal fade" id="preview_foto" role="dialog">
                    <div id="width_preview_foto" class="modal-dialog" style="width: 50%">
                        <div class="modal-content" style="background-color: #fff;">
                            <div class="modal-body">

                            	<button type="button" class="close pull-right" data-dismiss="modal"><i style="color: #14193c;font-size: 30px; margin-bottom: 0px" class="material-icons">close</i></button>
                            	
                            	<div class="row">
                            		
                            		<div class="col-xs-12" style="text-align:left">
                            			<h4 id="deskripsi_foto">news 4</h4>
                            		</div>
                            		<div class="col-xs-12">
                            			<img class="img" id="img_detil" src="" style="width: 100%">
                            		</div>
                            	</div>
                            </div>
                        </div>
...
<script type="text/javascript">	
    ...
    function detil_berita(screen,id){
    	$.ajax({
            ...
            success: function(data) {
            	if (window_width >= 769) {
            		$('#date_berita').text(data.waktu); 
	            	$('#judul_berita').text(data.judul); 
	            	$('#deskripsi_berita').text(data.deskripsi); 
	            	 $("#img_berita").attr('src','<?php echo base_url()?>assets/img/berita/'+data.img);
	            	$('#detil_berita').modal('show'); 
            	}
            	else if (window_width <= 768) {
            		$('#date_berita_mobile').text(data.waktu); 
	            	$('#judul_berita_mobile').text(data.judul); 
	            	$('#deskripsi_berita_mobile').text(data.deskripsi); 
	            	 $("#img_berita_mobile").attr('src','<?php echo base_url()?>assets/img/berita/'+data.img);
	            	$('#detil_berita_mobile').modal('show'); 
            	}
	...
	function open_cari_head(){
		get_kegiatan_header();
		$('#search').modal('show');
		$("#cari_header").click();
	}

	function close_cari_head(){
		$('#cari_head').hide();
		get_kegiatan_header();
	}
	...
	function detil_program(id){
    	asal_halaman_program = 'Home';
    	id_program = id;
        get_content('Detil_program');
    }

    function preview_berita_image(id){
        $('#image_list').empty();
        $('#preview_image').modal('show');
        //alert()
        var rows = "<img class='img-responsive' src='<?php echo base_url()?>assets/img/berita/"+id+"' style='width: 100%; border-radius:5px;'>";
	...
	function get_content(page){
		...
		if (page == 'Dashboard') {
			...
			$('#content_page').empty();
	        $.ajax({
	            url : "<?php echo site_url('Front/get_content_desktop')?>",
	            type: "POST",
	            data: { 
		          "page" : page
		        },
