	...
	<nav id="navbar_mobile" hidden="" class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color: white; padding-bottom: 0px">
		...
		<div id="header_kegiatan" class="header"  style="background-image: url('<?php echo base_url()?>assets/img/desk.png'); background-size: cover;height: 60vh; min-height: auto">
            <div class="container" style="padding-top: 20vh; width: 90%">
                <div class="row">
					<div class="col-md-7" style="color: black; margin-left: 20px">
						<p id="judul_kegiatan" style="font-weight: inherit;color: #4fc143">Kegiatan sosial terkini</p>
						<p id="sub_judul_kegiatan">Program penggalangan dana dari para relawan salingbantu.or.id</p>
					</div>
						...
						<div class="" >
								<div class="col-md-4 col-xs-12">
									<div class="input-group">
										...
										<div class="form-group is-empty">
											<input id="cari_program" style="font-size: 20px" class="form-control" placeholder="Judul kegiatan" type="text">
								...
								<div class="col-md-3 col-xs-12">
									<div class="input-group">
										...
										<div class="form-group label-floating is-empty">
	                                        <select onchange="get_kegiatan_2()" id="kategori" class="form-control">
								...
								<div class="col-md-1 col-xs-6" style="margin-top: 25px; padding-left: 30px">
									<h4 id="terbaru" onclick="terbaru()" align="center" style="cursor: pointer;border-bottom: solid;font-weight: bold">Terbaru</h4>
								</div>

								<div class="col-md-1 col-xs-6" style="margin-top: 25px; padding-right: 30px">
								...
								<div class="col-md-4 col-sm-6 col-xs-12" id="kolom_kegiatan_1_">
		                        </div>
		                        <div class="col-md-4 col-sm-6 col-xs-12" id="kolom_kegiatan_2_">
		                        </div>
		                        <div class="col-md-4 col-sm-6 col-xs-12" id="kolom_kegiatan_3_">
		                        </div>
		                        <div class="col-md-4 col-sm-6 col-xs-12" id="kolom_kegiatan_4_">
		                        </div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		get_kegiatan_2();
		if (window_width <= 768) {
           $("#header_kegiatan").css('height','unset');
           $("#judul_kegiatan").css('font-size','1.5em');
           $("#judul_kegiatan").css('font-weight','bold');
            $("#sub_judul_kegiatan").css('font-size','1.1em');
        }
        else{
            $("#header_kegiatan").css('height','60vh');
            $("#judul_kegiatan").css('font-size','2.6em');
            $("#sub_judul_kegiatan").css('font-size','1.825em');
    ...
    function get_kegiatan_2(){
		$.ajax({
            ...
            success: function(data) {
            	$('#kolom_kegiatan_1_').empty(); $('#kolom_kegiatan_2_').empty(); $('#kolom_kegiatan_3_').empty();
            	var status;
            	var looping = 1;
                $.each(data, function(k, v) {
                	...
                	rows="<div class='card card-raised card-carousel' style='margin: 10px; margin-top: 20px; border-radius: 5px; box-shadow: 0 0px 3px -1px rgba(0, 0, 0, 0.18), 0 4px 25px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2)'><div id='carousel-example-kegiatan_"+id+"' class='carousel slide' data-ride='carousel'><div class='carousel slide' data-ride='carousel'><ol class='carousel-indicators' id='carousel_kegiatan_"+id+"' style='bottom:-5px; left:40%; width:80%'></ol><div class='carousel-inner' style='width: 100%; height: 200px;' id='carousel_img_kegiatan"+id+"'></div><a class='left carousel-control' href='#carousel-example-kegiatan_"+id+"' data-slide='prev'><i class='material-icons'>keyboard_arrow_left</i></a><a class='right carousel-control' href='#carousel-example-kegiatan_"+id+"' data-slide='next'><i class='material-icons'>keyboard_arrow_right</i></a></div><div class='content' style='text-align: left'><div class='row'><div class=''><div class='col-xs-8'><p class='category' style='text-transform: uppercase; color:#4fc143'><i class='material-icons'>sort</i>"+v.nama_kategori+"</p></div><div class='col-xs-4'>"+status+"</div></div></div><p class='select_text' onclick=detil_kegiatan2('"+id+"') style='width: 100%; cursor:pointer; font-weight:bold;'>"+v.judul+"</p><div class='row' style='margin-top: 15px'><div class='col-md-3 col-sm-3 col-xs-3' style='text-align: left; height: 10px'><div class='circles'><div class='second circle "+id+"'><strong></strong></div></div></div><div class='col-md-5 col-sm-5 col-xs-5' style='text-align: left'><p style='margin-bottom: 0px'>Terkumpul</p><p><b>Rp. "+accounting.formatNumber(v.tercapai_dana)+"</b></p></div><div class='col-md-4 col-sm-4 col-xs-4' style='text-align: left'><p style='margin-bottom: 0px'>Berakhir</p><p><b>"+v.tanggal_berakhir+"</b></p></div></div></div></div></div>";

                	if (looping == 1) {
                        $(rows).appendTo("#kolom_kegiatan_1_");
                    }
                    else if (looping == 2) {
                        $(rows).appendTo("#kolom_kegiatan_2_");
                    }
                    else if (looping == 3) {
                        $(rows).appendTo("#kolom_kegiatan_3_");
                        looping = 0;
                    }
					...
					$.ajax({
				            ...
				            success: function(data) {
				                ...
				                $.each(data, function(a, b) {
				                	...
				                	img1 += 1;
				                	$(rows3).appendTo("#carousel_img_kegiatan"+id);
				                });
	...
	function detil_kegiatan2(id){
		asal_halaman_kegiatan = 'Kegiatan'
        id_kegiatan = id;
