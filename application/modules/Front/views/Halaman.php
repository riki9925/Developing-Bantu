	...
	<nav id="navbar_mobile" hidden="" class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color: white; padding-bottom: 0px">
		...
		<div class="header" id="cover_halaman" style="background-image: url('<?php echo base_url()?>assets/img/desk.png'); background-size: cover;height: 60vh; min-height: auto">
            <div class="container" style="padding-top: 20vh; width: 80%">
                <div class="row">
					<div class="col-md-12" align="center" style="color: black; margin-left: 10px">
						<p id="judul_halaman" style="font-weight: bold;color: #4fc143"></p>
						
						<p id="deskripsi_halaman">We added extra classes that can help you better customise the look. You can use regular buttons,<br> rounded corners buttons or plain simple buttons. Let's see some examples: </p>
					</div>
                </div>
            </div>
        </div>
		...
		<div class="main" id="main_halaman" style="margin-bottom: 30px; margin-left: 150px; margin-right: 150px; padding-left: 30px; padding-right: 30px; background-color: transparent;">
		    	...
		    	<div class="section text-center section-landing" style="padding: 0px 0">
	    			<div class="row" style="margin-top: 30px; padding-bottom: 50px">
	    				...
	    				<div class="col-sm-8  text-left" style="padding-left: 30px; padding-right: 30px">
	    					<p id="deskripsi_halaman" style="font-size: 18px"></p>
	    				</div>

	    				<div class="col-sm-4 col-xs-12 text-left" id="action_halaman">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        if (window_width <= 768) {
        	alert()
           $("#judul_halaman").css('font-size','1.5em');
           $("#judul_halaman").css('font-weight','bold');
            $("#deskripsi_halaman").css('font-size','1.1em');
            $("#head1").hide();
			$("#navbar_desktop").hide();
			$("#navbar_mobile").show();
        }
        else{
            $("#judul_halaman").css('font-size','2.6em');
            $("#deskripsi_halaman").css('font-size','1.825em');
            $("#head1").show();
			$("#navbar_desktop").show();
			$("#navbar_mobile").hide();
	...
	function get_content_page2(page, section){
		$.ajax({
	            ...
	            {
	            	$('#judul_halaman').text(data.judul);
	            	$('#deskripsi_halaman').text(data.deskripsi);
	            	$('#cover_halaman').css('background-image', "url(<?php echo base_url()?>assets/img/header/"+data.img+")"); 
	            	//$('#img_halaman').css('background-image', '<?php echo base_url()?>assets/img/header/'+data.img);
