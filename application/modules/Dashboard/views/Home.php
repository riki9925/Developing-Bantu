        ...
        <div class="main-panel">
            ...
            <!-- kegiatan -->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #4fc143; padding-bottom: 10px">
                                  ...
                                  <h4 style="color: white" class="modal-title"><b>Tambah Kegiatan2</b></h4>
                            </div>
                ...
                <!-- tambah foto -->
                <div class="modal fade" id="tambah_gambar" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #4fc143; padding-bottom: 10px">
                                <button type="button" class="close" data-dismiss="modal"><i style="color: white;font-size: 20px" class="material-icons">close</i></button>
                                <h4 style="color: white" class="modal-title"><b>Tambah gambar</b></h4>
                            </div>

                            <div class="modal-body">
                                <form  name="form_image_upload" id="form_image_upload" enctype="multipart/form-data" accept-charset="utf-8">
                                    <div class="fileinput fileinput-new" style="width: 100%; margin-top: 15px" data-provides="fileinput">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <div class="alert alert-warning" id="img_kosong" hidden="">
                                                    <span><b> INFORMASI - </b> Anda belum memilih foto kegiatan</span>
                                                </div>
                                                <div>
                                                    <span class="btn btn-info btn-round btn-file">
                                                        ...
                                                        <input type="file" id="wizard-picture_kegiatan" name="wizard-picture_kegiatan" />
                                                    </span>
                            ...
                            <div class="modal-footer">
                                <button onclick="upload2()" data-dismiss="modal" class="btn btn-fill btn-success">Upload gambar</button>
                            </div>
