        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a id="judul_konten" class="navbar-brand" href="#"> Dashboard administrator</a>
                    </div>
            ...
            <div class="content" id="content_administrator">
                    ...
                    <div class="modal fade" id="modal_verifikasi_kegiatan" role="dialog">
                        <div class="modal-dialog" style="margin-top: 30px">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer" style="border-top: solid 1px whitesmoke; padding-top: 15px">
                                <div class="row">
                                    <div class="col-sm-6 col-xs-6">
                                        <button class="btn btn-danger pull-left" data-dismiss="modal" id="btn_block_kegiatan" hidden="">
                                            <i class="material-icons">close</i> <?php echo $this->lang->line('blokir')?>
                                        <div class="ripple-container"></div></button>
                                    </div>

                                    <div class="col-sm-6 col-xs-6">
                                        <button data-dismiss="modal" id="btn_setujui_kegiatan" hidden="" class="btn btn-success pull-right">
                                            <span class="btn-label">
                                                <i class="material-icons">check</i>
                                            </span>
                                            <?php echo $this->lang->line('setujui')?>
                                        <div class="ripple-container"></div></button>
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog" style="margin-top: 30px">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                                ...
                                                <div class="col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group label-floating is-empty nomargin">
                                                                <label class="control-label"></label>
                                                                <input disabled="" id="nama_lengkap" class="form-control" placeholder="Tulis nama lengkapmu" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group label-floating is-empty nomargin">
                                                                <label class="control-label"></label>
                                                                <input disabled="" id="email" class="form-control" placeholder="Tulis alamat e-mailmu" type="email">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group label-floating is-empty nomargin">
                                                        <label class="control-label"></label>
                                                        <input disabled="" id="alamat" class="form-control" placeholder="Tulis alamat anda" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" >
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group label-floating is-empty nomargin">
                                                        <input disabled="" id="provinsi" class="form-control" placeholder="Tulis alamat anda" type="text">
                                                        </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" >
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group label-floating is-empty nomargin">
                                                    <input disabled="" id="kota" class="form-control" placeholder="Tulis alamat anda" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group label-floating is-empty nomargin">
                                                        <label class="control-label"></label>
                                                        <input disabled="" id="hp" class="form-control" placeholder="Tulis nomor handphonemu" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" >
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group label-floating is-empty nomargin">
                                                        ...
                                                        <input disabled="" id="jenis_ki" class="form-control" placeholder="Tulis alamat anda" type="text">
                                                        </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea disabled="" id="bio" placeholder="Deskripsikan diri anda dalam beberapa kalimat" class="form-control nomargin" rows="5"></textarea>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="btn_invalid" onclick="validasi_data_diri('INVALID')" class="btn btn-danger pull-left" data-dismiss="modal">
                                        <i class="material-icons">highlight_off</i> <?php echo $this->lang->line('data_tidak_valid')?>
                                    <div class="ripple-container"></div></button>

                                    <button data-dismiss="modal" id="btn_valid" onclick="validasi_data_diri('VALID')" class="btn btn-info pull-right"><i class="material-icons">done</i> <?php echo $this->lang->line('data_valid')?><div class="ripple-container"></div></button>
    ...
    function load_table_cari_akun(){
        table_cari_akun = $('#table_cari_akun').DataTable({ 
            ...
            // Load data for the table's content from an Ajax source
                "ajax": {
                    "url": "<?php echo site_url('Administrator/load_table_cari_akun')?>",
                    "type": "POST",  
                    "data": function ( data ) {
                        data.layar = layar;
                    },
    ...
    function get_content(page){
        ...
        if (page == 'Front') {
            ...
            $.ajax({
                ...
                {
                    $('#content_administrator').html(data);
                },
