                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2" style="border-right: solid 1px #4fc143">
                                                    <button onclick="get_content('Tambah_program_terkini')" style="margin: 0px; background-color: #4fc143; color: white" id="minimizeSidebar" class="btn btn-round btn-white btn-fill btn-just-icon">
...
<script type="text/javascript">
    ...
    function load_table_program_terkini(){
        table_program_terkini = $('#table_program_terkini').DataTable({ 
            ...
            // Load data for the table's content from an Ajax source
                "ajax": {
                    "url": "<?php echo site_url('Administrator/load_table_program_terkini')?>",
                    "type": "POST",  
                    "data": function ( data ) {
                        data.layar = layar;
    ...
    function delete_program_terkini(id){
            ...
            .then(function() {
                ...
                $.ajax({
                    url : "<?php echo site_url('Administrator/hapus_program_terkini')?>",
                    type: "POST",
                    data: { 
                      "id" : id
                    },
    ...
    function draft_program_terkini(id){
        action_program_terkini = 'draft';
    ...
    function selesai_program_terkini(id){
    ...
    function live_program_terkini(id){
        $('#btn_aktifkan_program').hide();
        action_program_terkini = 'live';
        id_program_terkini = id;
        get_content('Tambah_program_terkini');
    }
