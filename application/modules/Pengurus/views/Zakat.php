...
<script type="text/javascript">
    ...
    function set_responsive_zakat(){
        ...
        if (layar == 'big') {
            ...
            rows = "<th><?php echo $this->lang->line('dermawan')?></th><th><?php echo $this->lang->line('nominal_zakat')?></th><th><?php echo $this->lang->line('waktu')?></th>";
            $(rows).appendTo("#thead_zakat");
        }
    }
    ...
    function load_table_zakat(){
        table_zakat = $('#table_zakat').DataTable({ 
            ...
            // Load data for the table's content from an Ajax source
                "ajax": {
                    "url": "<?php echo site_url('Pengurus/load_table_zakat')?>",
                    "type": "POST",  
                    "data": function ( data ) {
                        data.layar = layar;
                    },
