...
class Pengurus extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        if ($this->session->userdata('level_user') != 'PENGURUS') {
            redirect('Front/home');
        }
    ...
    public function index() {
      ...
      $this->load->view('layout/Header_pengurus');
      $this->load->view('layout/Sidebar_pengurus');
      $this->load->view('Home');
    }
    ...
    function load_table_laporan_keu(){
       ...
       $list = $this->M_pengurus->m_load_table('lap_keu');
       $data = array();
       $no = $_POST['start'];
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('lap_keu'),
                       "data" => $data,
               );
    ...
    function load_table_kategori(){
       ...
       $list = $this->M_pengurus->m_load_table('kategori');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('kategori'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_akun_jenis(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('jenis');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('jenis'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_laporan_transaksi(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('transaksi');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('transaksi'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_akun_kelompok(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('kelompok');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('kelompok'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_akun_bb(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('bb');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('bb'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_akun_sbb(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('sbb');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('sbb'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_ju(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('ju');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('ju'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_cari_akun(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('cari_akun');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('cari_akun'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_draft_jurnal(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('draft_jurnal');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('draft_jurnal'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_jurnal_umum(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('jurnal_umum');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('jurnal_umum'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_berita(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('berita');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('berita'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_kegiatan(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('kegiatan');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
           $row = array();
            ...
            if ($layar == 'big') {
                ...
                $row[] = '<div class="pull-right"><a href="#" onclick="detil_live('.$hasil->id_kegiatan.')" class="btn btn-simple btn-info btn-icon"><i class="material-icons" style="font-size:30px">info_outline</i></a></div>';
                
            }
            else{
                $row[] = "<div onclick='detil_live(".$hasil->id_kegiatan.")'><p style='margin-left:-20px'>".$hasil->judul."</p>".
                ...
                $row[] = "<div onclick='detil_live(".$hasil->id_kegiatan.")'><p class='pull-right'>".$hasil->target_dana."</p><br>".
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('kegiatan'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_program_terkini(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('program_terkini');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
           $row = array();
            ...
            if ($layar == 'big') {
                ...
                $row[] = '<div class="pull-right"><a href="#" onclick="detil_program_terkini('.$hasil->id.')" class="btn btn-simple btn-info btn-icon"><i class="material-icons" style="font-size:30px">launch</i></a></div>';
                
            }
            else{
                $row[] = "<div onclick='detil_program_terkini(".$hasil->id.")'><p style='margin-left:-20px'>".$hasil->judul."</p>".
                ...
                $row[] = "<div onclick='detil_program_terkini(".$hasil->id.")'><p class='pull-right'>".number_format($hasil->target_dana)."</p><br>".
                        "<p class='category' style='margin-top:10px;font-size:12px;text-align:right'>".$hasil->target_hari." Hari</p><br>".
                        "<p class='category' style='margin-top:0px;text-align:right;font-size:12px;color:".$color."'>".$hasil->status."</p></div>";
            }
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('program_terkini'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_jaringan_g(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('jaringan_g');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
           $row = array();
            ...
            if ($layar == 'big') {
                ...
                $row[] = $hasil->nama_provinsi."<br>".$hasil->nama_kota; 
                $row[] = '<span class="label label-'.$color.'">'.$hasil->status.'</span>';
                $row[] = '<div class="pull-right"><a href="#" onclick="selesai_jaringan_g('.$hasil->id.')" class="btn btn-simple btn-info btn-icon"><i class="material-icons" style="font-size:30px">info_outline</i></a></div>';
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('jaringan_g'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_slider(){
      $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('slider');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('slider'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_video(){
      $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('video');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('video'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_dukungan(){
      $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('dukungan');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('dukungan'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_user(){
      $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('user');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
           $row = array();
            ...
            if ($layar == 'big') {
                ...
                $row[] = '<img class="img-circle" src="'.base_url()."assets/img/foto/".$hasil->img.'" style="height: 35px; width: 35px">'.'<br>'.$hasil->nama;
                $row[] = '<p style="color:'+$color+'">'.$hasil->st.'</p>';  
                $row[] = '<div onclick="detil_data_user('.$hasil->id.')" class="pull-right"><a href="#" class="btn btn-simple btn-info btn-icon"><i class="material-icons" style="font-size:30px">info_outline</i></a></div>';
            }
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('user'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_zakat(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('zakat');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
           $row = array();
            ...
            if ($layar == 'big') {
                ...
                $row[] = '<p style="margin-left:-25px">'.$hasil->nama.'</p>'; 
                $row[] = number_format($hasil->nilai_zakat); 
                $row[] = '<p style="padding-right:0px">'.$hasil->waktu.'</p>'; 
            }
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('zakat'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
    ...
    function load_table_infaq(){
        $layar = $this->input->post('layar');
       $list = $this->M_pengurus->m_load_table('infaq');
       $data = array();
       $no = $_POST['start'];
       foreach ($list as $hasil) {
           $no++;
       ...
       $output = array(
                       "draw" => $_POST['draw'],
                        "recordsFiltered" => $this->M_pengurus->count_filtered('infaq'),
                       "data" => $data,
               );
       echo json_encode($output);
    }
